...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:5: x:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bnulltest.floyd:6: y:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bnulltest.floyd:8: init(initX:int;initY:int):Pointis
# -------------------------
Point_init:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:10: x:=initX
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	popl   %eax
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bnulltest.floyd:11: y:=initY
# -------------------------
# AssignStmt
	pushl  16(%ebp)
	popl   %eax
	...
	movl   %eax, 12(%ebx)
# -------------------------
# btests\bnulltest.floyd:12: init:=me
# -------------------------
# AssignStmt
	pushl  8(%ebp)
	popl   %eax
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:15: getX():intis
# -------------------------
Point_getX:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:17: getX:=x
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  8(%ebx)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:20: getY():intis
# -------------------------
Point_getY:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:22: getY:=y
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  12(%ebx)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:25: print()is
# -------------------------
Point_print:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:27: out.writeint(x)
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
	...
	addl   $8, %esp
# -------------------------
# btests\bnulltest.floyd:28: out.writeint(y)
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:31: setXY(newX:int;newY:int)is
# -------------------------
Point_setXY:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:33: x:=newX
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	popl   %eax
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bnulltest.floyd:34: y:=newY
# -------------------------
# AssignStmt
	pushl  16(%ebp)
	popl   %eax
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:37: setX(newX:int)is
# -------------------------
Point_setX:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:39: setXY(newX,y)
# -------------------------
	movl   8(%ebp), %ebx
	pushl  12(%ebx)
	pushl  12(%ebp)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:42: setY(newY:int)is
# -------------------------
Point_setY:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:44: y:=newY
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	popl   %eax
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:52: doit(p:Point)is
# -------------------------
Bnulltest_doit:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:54: p.print()
# -------------------------
# MethodCallExpr
	pushl  12(%ebp)
	pushl  $54
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bnulltest.floyd:57: start()is
# -------------------------
Bnulltest_start:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bnulltest.floyd:58: p1:Point
# -------------------------
	pushl  $0
# -------------------------
# btests\bnulltest.floyd:59: p2:Point
# -------------------------
	pushl  $0
# -------------------------
# btests\bnulltest.floyd:61: p1:=newPoint
# -------------------------
# AssignStmt
	pushl  $16
	pushl  $1
...
# VARNAME:p1 is a local var
	movl   %eax, -8(%ebp)
# -------------------------
# btests\bnulltest.floyd:62: p1.init(5,10)
# -------------------------
# MethodCallExpr
	pushl  -8(%ebp)
	pushl  $62
	...
	addl   $12, %esp
# -------------------------
# btests\bnulltest.floyd:64: p2:=null
# -------------------------
# AssignStmt
	pushl  $0
	popl   %eax
# VARNAME:p2 is a local var
	movl   %eax, -12(%ebp)
# -------------------------
# btests\bnulltest.floyd:66: doit(p1)
# -------------------------
	pushl  -8(%ebp)
	pushl  8(%ebp)
	call   Bnulltest_doit
	...
	popl   %eax
# -------------------------
# btests\bnulltest.floyd:67: doit(p2)
# -------------------------
	pushl  -12(%ebp)
	pushl  8(%ebp)
	call   Bnulltest_doit
