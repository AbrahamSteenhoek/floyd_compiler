...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:5: x:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bobjbasics.floyd:6: y:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bobjbasics.floyd:8: init(initX:int;initY:int):Pointis
# -------------------------
Point_init:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:10: x:=initX
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	popl   %eax
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bobjbasics.floyd:11: y:=initY
# -------------------------
# AssignStmt
	pushl  16(%ebp)
	popl   %eax
	...
	movl   %eax, 12(%ebx)
# -------------------------
# btests\bobjbasics.floyd:12: init:=me
# -------------------------
# AssignStmt
	pushl  8(%ebp)
	popl   %eax
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:15: getX():intis
# -------------------------
Point_getX:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:17: getX:=x
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  8(%ebx)
	popl   %eax
# VARNAME:getX is a local var
	movl   %eax, -4(%ebp)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:20: getY():intis
# -------------------------
Point_getY:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:22: getY:=y
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  12(%ebx)
	popl   %eax
# VARNAME:getY is a local var
	movl   %eax, -4(%ebp)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:25: print()is
# -------------------------
Point_print:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:27: out.writeint(x)
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
	...
	addl   $8, %esp
# -------------------------
# btests\bobjbasics.floyd:28: out.writeint(y)
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:31: setXY(newX:int;newY:int)is
# -------------------------
Point_setXY:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:33: x:=newX
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	popl   %eax
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bobjbasics.floyd:34: y:=newY
# -------------------------
# AssignStmt
	pushl  16(%ebp)
	popl   %eax
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:37: setX(newX:int)is
# -------------------------
Point_setX:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:39: setXY(newX,y)
# -------------------------
	movl   8(%ebp), %ebx
	pushl  12(%ebx)
	pushl  12(%ebp)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:42: setY(newY:int)is
# -------------------------
Point_setY:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:44: y:=newY
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	popl   %eax
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bobjbasics.floyd:52: start()is
# -------------------------
Bobjbasics_start:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bobjbasics.floyd:53: p1:Point
# -------------------------
	pushl  $0
# -------------------------
# btests\bobjbasics.floyd:54: p2:Point
# -------------------------
	pushl  $0
# -------------------------
# btests\bobjbasics.floyd:56: p1:=newPoint
# -------------------------
# AssignStmt
	pushl  $16
	pushl  $1
	...
	pushl  %eax
	popl   %eax
# VARNAME:p1 is a local var
	movl   %eax, -8(%ebp)
# -------------------------
# btests\bobjbasics.floyd:57: p1.init(5,10)
# -------------------------
# MethodCallExpr
	pushl  -8(%ebp)
	pushl  $57
	...
	addl   $12, %esp
# -------------------------
# btests\bobjbasics.floyd:59: p2:=(newPoint).init(100,200)
# -------------------------
# AssignStmt
# MethodCallExpr
	pushl  $16
	...
	pushl  %eax
	popl   %eax
# VARNAME:p2 is a local var
	movl   %eax, -12(%ebp)
# -------------------------
# btests\bobjbasics.floyd:61: p1.print()
# -------------------------
# MethodCallExpr
	pushl  -8(%ebp)
	pushl  $61
	...
	addl   $4, %esp
# -------------------------
# btests\bobjbasics.floyd:62: p2.print()
# -------------------------
# MethodCallExpr
	pushl  -12(%ebp)
	pushl  $62
	...
	addl   $4, %esp
# -------------------------
# btests\bobjbasics.floyd:64: p1.setX(-5)
# -------------------------
# MethodCallExpr
	pushl  -8(%ebp)
	pushl  $64
...
# neg oper
	...
	addl   $8, %esp
# -------------------------
# btests\bobjbasics.floyd:65: p1.print()
# -------------------------
# MethodCallExpr
	pushl  -8(%ebp)
	pushl  $65
	...
	addl   $4, %esp
# -------------------------
# btests\bobjbasics.floyd:66: p2.print()
# -------------------------
# MethodCallExpr
	pushl  -12(%ebp)
	pushl  $66
