...
# Method Postlude
	...
	ret
# -------------------------
# btests\bchange.floyd:6: Amt:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bchange.floyd:7: Quarters:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bchange.floyd:8: Dimes:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bchange.floyd:9: Nickels:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bchange.floyd:11: ComputeChange(amt:int;denom:int):intis
# -------------------------
...
# reserve space for local vars
# -------------------------
# btests\bchange.floyd:13: ComputeChange:=amt/denom
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	pushl  16(%ebp)
	...
	pushl  %eax
	popl   %eax
# VARNAME:ComputeChange is a local var
	movl   %eax, -4(%ebp)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bchange.floyd:16: ComputeRemain(amt:int;denom:int;qtydenom:int):intis
# -------------------------
...
# reserve space for local vars
# -------------------------
# btests\bchange.floyd:18: ComputeRemain:=amt-denom*qtydenom
# -------------------------
# AssignStmt
	pushl  12(%ebp)
	pushl  16(%ebp)
	...
	pushl  %eax
	popl   %eax
# VARNAME:ComputeRemain is a local var
	movl   %eax, -4(%ebp)
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bchange.floyd:21: start()is
# -------------------------
BChange_start:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bchange.floyd:23: out.write("Enter the amount of the purchase in cents: ")
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bchange.floyd:23: string lit
# -------------------------
.data
stringlit1:
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bchange.floyd:24: Amt:=in.readint()
# -------------------------
# AssignStmt
# MethodCallExpr
	pushl  _in
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bchange.floyd:28: Quarters:=ComputeChange(Amt,25)
# -------------------------
# AssignStmt
	pushl  $25
	movl   8(%ebp), %ebx
	...
	movl   %eax, 12(%ebx)
# -------------------------
# btests\bchange.floyd:29: out.write("Quarters: ".catInt(Quarters).cat("\n"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# MethodCallExpr
# -------------------------
# btests\bchange.floyd:29: string lit
# -------------------------
.data
stringlit2:
.string "Quarters: "
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bchange.floyd:30: Amt:=ComputeRemain(Amt,25,Quarters)
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  12(%ebx)
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bchange.floyd:33: Dimes:=ComputeChange(Amt,10)
# -------------------------
# AssignStmt
	pushl  $10
	movl   8(%ebp), %ebx
	...
	movl   %eax, 16(%ebx)
# -------------------------
# btests\bchange.floyd:34: out.write("Dimes: ".catInt(Dimes).cat("\n"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# MethodCallExpr
# -------------------------
# btests\bchange.floyd:34: string lit
# -------------------------
.data
stringlit4:
.string "Dimes: "
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bchange.floyd:35: Amt:=ComputeRemain(Amt,10,Dimes)
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  16(%ebx)
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bchange.floyd:37: Nickels:=ComputeChange(Amt,5)
# -------------------------
# AssignStmt
	pushl  $5
	movl   8(%ebp), %ebx
	...
	movl   %eax, 20(%ebx)
# -------------------------
# btests\bchange.floyd:38: out.write("Nickels: ".catInt(Nickels).cat("\n"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# MethodCallExpr
# -------------------------
# btests\bchange.floyd:38: string lit
# -------------------------
.data
stringlit6:
.string "Nickels: "
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bchange.floyd:40: Amt:=ComputeRemain(Amt,5,Nickels)
# -------------------------
# AssignStmt
	movl   8(%ebp), %ebx
	pushl  20(%ebx)
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bchange.floyd:42: out.write("Pennies: ".catInt(Amt).cat("\n"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# MethodCallExpr
# -------------------------
# btests\bchange.floyd:42: string lit
# -------------------------
.data
stringlit8:
.string "Pennies: "
