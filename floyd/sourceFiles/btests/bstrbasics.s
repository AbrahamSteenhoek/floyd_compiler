...
# Method Postlude
	...
	ret
# -------------------------
# btests\bstrbasics.floyd:6: s:String
# -------------------------
	pushl  $0
# -------------------------
# btests\bstrbasics.floyd:8: print(q:String):Stringis
# -------------------------
Bstrbasics_print:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bstrbasics.floyd:10: print:="q = ".cat(q).cat("\n")
# -------------------------
# AssignStmt
# MethodCallExpr
# MethodCallExpr
# -------------------------
# btests\bstrbasics.floyd:10: string lit
# -------------------------
.data
stringlit1:
.string "q = "
...
# Method Postlude
	...
	ret
# -------------------------
# btests\bstrbasics.floyd:13: start()is
# -------------------------
Bstrbasics_start:
# Method Preamble
	pushl  %ebp
...
# reserve space for local vars
# -------------------------
# btests\bstrbasics.floyd:14: len:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bstrbasics.floyd:15: firstCh:int
# -------------------------
	pushl  $0
# -------------------------
# btests\bstrbasics.floyd:17: out.write("Enter a string of characters:")
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:17: string lit
# -------------------------
.data
stringlit3:
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bstrbasics.floyd:18: s:=in.readline()
# -------------------------
# AssignStmt
# MethodCallExpr
	pushl  _in
	...
	movl   %eax, 8(%ebx)
# -------------------------
# btests\bstrbasics.floyd:19: len:=s.length()
# -------------------------
# AssignStmt
# MethodCallExpr
	movl   8(%ebp), %ebx
...
# VARNAME:len is a local var
	movl   %eax, -8(%ebp)
# -------------------------
# btests\bstrbasics.floyd:20: firstCh:=s.charAt(0)
# -------------------------
# AssignStmt
# MethodCallExpr
	movl   8(%ebp), %ebx
	...
	pushl  %eax
	popl   %eax
# VARNAME:firstCh is a local var
	movl   %eax, -12(%ebp)
# -------------------------
# btests\bstrbasics.floyd:22: out.write("s has ".catInt(len).cat(" characters.\n"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# MethodCallExpr
# -------------------------
# btests\bstrbasics.floyd:22: string lit
# -------------------------
.data
stringlit4:
.string "s has "
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bstrbasics.floyd:23: out.write("charAt(0) = '".catChar(firstCh).cat("'\n"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
...
# MethodCallExpr
# -------------------------
# btests\bstrbasics.floyd:23: string lit
# -------------------------
.data
stringlit6:
.string "charAt(0) = '"
...
.text
	...
	addl   $8, %esp
# -------------------------
# btests\bstrbasics.floyd:25: ifs.gt(" ")then
# -------------------------
# MethodCallExpr
	movl   8(%ebp), %ebx
	pushl  8(%ebx)
	...
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:25: string lit
# -------------------------
.data
stringlit8:
.string " "
...
trueif13:
# -------------------------
# btests\bstrbasics.floyd:26: out.write("s > ' '\n")
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:26: string lit
# -------------------------
.data
stringlit9:
.string "s > ' '\n"
...
falseif13:
# -------------------------
# btests\bstrbasics.floyd:28: out.write("! s > ' '\n")
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:28: string lit
# -------------------------
.data
stringlit10:
.string "! s > ' '\n"
...
endif13:
# -------------------------
# btests\bstrbasics.floyd:31: ifs.gteq(" ")then
# -------------------------
# MethodCallExpr
	movl   8(%ebp), %ebx
	pushl  8(%ebx)
	...
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:31: string lit
# -------------------------
.data
stringlit11:
.string " "
...
trueif14:
# -------------------------
# btests\bstrbasics.floyd:32: out.write("s >= ' '\n")
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:32: string lit
# -------------------------
.data
stringlit12:
.string "s >= ' '\n"
...
falseif14:
# -------------------------
# btests\bstrbasics.floyd:34: out.write("! s >= ' '\n")
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:34: string lit
# -------------------------
.data
stringlit13:
.string "! s >= ' '\n"
...
endif14:
# -------------------------
# btests\bstrbasics.floyd:37: out.write(print("wowsers!"))
# -------------------------
# MethodCallExpr
	pushl  _out
	popl   %ecx
# -------------------------
# btests\bstrbasics.floyd:37: string lit
# -------------------------
.data
stringlit14:
.string "wowsers!"
